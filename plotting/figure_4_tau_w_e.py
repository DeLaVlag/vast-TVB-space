...
measures = {'mean_FR_e':{'max':5, 'min':0.0, 'unit':'excitatory\nmean\nfiring rate\nin Hz'},
            ...
            'pmax_prom_e':{'max':2e6, 'min':45000.0, 'unit':'excitatory\n amplitude\nfrequency'},
            'score_PSD_e':{'max':0.95, 'min':0.8, 'unit':'excitatory\n PSD closest to\n a line'},
...
fig, axs = plt.subplots(7,4,figsize=(6.8, 6.8))
for j in range(4):
